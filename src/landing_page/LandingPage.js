  ...
  render() {
    return (
      <div className="snap-container">
        <Navbar/>
        <HeroBanner title="I'm Jason Shen" subtitle='The stuff that makes you foolish as a kid are what makes you great as an adult' imgSrc="/img/landing_page/header_banner.JPEG"/>
